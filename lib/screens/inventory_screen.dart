...
class _InventoryScreenState extends State<InventoryScreen> {
    ...
    setState(() {
      switch (_currentSort) {
        ...
        case SortMode.rarity:
          items.sort((a, b) {
            final rA = Rarity.values
                .firstWhere((e) => e.name == a['rarity'])
                .index;
            final rB = Rarity.values
                .firstWhere((e) => e.name == b['rarity'])
                .index;
        ...
        case SortMode.value:
          items.sort((a, b) {
            final vA = Rarity.values
                .firstWhere((e) => e.name == a['rarity'])
                .value;
            final vB = Rarity.values
                .firstWhere((e) => e.name == b['rarity'])
                .value;
  ...
  void _toggleSort() {
    setState(() {
      _currentSort =
          SortMode.values[(_currentSort.index + 1) % SortMode.values.length];
      _applySort();
    });
  }
    ...
    if (count > 0) {
      ...
      messenger.showSnackBar(
        SnackBar(
          ...
          content: Text(
            "Liquidated $count ${rarity.name} items for $gain coins!",
                    ...
                    return Padding(
                      ...
                      child: ActionChip(
                        ...
                        backgroundColor: hasItems
                            ? r.color.withAlpha(40)
                            : Colors.transparent,
                        side: BorderSide(
                          color: hasItems ? r.color : Colors.white10,
                        ),
                    ...
                    : GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final rarity = Rarity.values.firstWhere(
                            (e) => e.name == item['rarity'],
                          );
                          // Hero tags must be unique even if items have the same name
                          final String heroTag =
                              "treasure_${item['name']}_${item['rarity']}_$index";
                          ...
                          return Dismissible(
                            ...
                            onDismissed: (direction) async {
                              ...
                              final bool canVibrate =
                                  !kIsWeb && await Vibration.hasVibrator();
                              if (!mounted) return;
                              ...
                              messenger.showSnackBar(
                                SnackBar(
                                  backgroundColor: rarity.color.withAlpha(200),
                                  content: Text(
                                    "Sold $itemName for $coinValue coins!",
                                    style: const TextStyle(
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  item['description'] ??
                      "An uncharted treasure recovered from the crushing depths of the abyss. Its properties are yet to be fully understood.",
                  textAlign: TextAlign.center,
                  style: const TextStyle(
                    fontSize: 16,
