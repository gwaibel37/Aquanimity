...
class MissionReportScreen extends StatelessWidget {
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                const OneShotFloat(
                  child: Icon(Icons.assignment_turned_in, color: Colors.cyanAccent, size: 40)
                ),
                const OneShotFloat(
                  delayMs: 200, 
                  child: Text("MISSION SUMMARY", style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, letterSpacing: 4))
                ),
                ...
                if (loot != null) ...[
                  OneShotFloat(
                    delayMs: 600,
                    child: Text(
                      isDuplicate ? "IDENTICAL SIGNATURE DETECTED" : "NEW ARTIFACT SECURED",
                      style: TextStyle(
                  ...
                  OneShotFloat(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: loot!.rarity.color.withAlpha(80), width: 2),
                        boxShadow: [
                          BoxShadow(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(color: loot!.rarity.color, fontSize: 13, fontWeight: FontWeight.w900, letterSpacing: 3)
                          ),
                        ],
                      ),
                    ),
                ...
                OneShotFloat(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text("RETURN TO SHIP", style: TextStyle(fontWeight: FontWeight.bold, letterSpacing: 2)),
                  ),
                ),
              ],
            ),
  ...
  Widget _reportRow(String label, String value, Color color) {
    return Row(
      ...
      children: [
        Text(label, style: const TextStyle(color: Colors.white38, fontSize: 11, letterSpacing: 1.5)),
